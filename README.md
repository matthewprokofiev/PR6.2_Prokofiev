...
трёх математических функций WPF-приложения (ПР4).

## Результаты работы приложения

### Страница 1 (формула с arctg/arccos)
![Page1](PRs/images/Page1_result.png)

### Страница 2 (кусочная функция S)
![Page2](PRs/images/Page2_result.png)

### Страница 3 (таблица и график)
...
- **Page1:** Рефакторинг вынес математику в статический метод `Calculate()`.
